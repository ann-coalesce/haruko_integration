...
class TradingVolumeProcessor:
    ...
    def process_fund_accounts(self) -> pd.DataFrame:
        """
        ...
        for _, row in mapping_df.iterrows():
            ...
            df = self.process_account_trades(account_id, pm)
            if not df.empty:
...
def run_trading_volume_job():
    ...
    try:
        ...
        volume_df = processor.process_fund_accounts()
